      ...
      {Object.keys(IndividualTVData).length > 0 ? (
        <>
          <section className="backdrop-poster relative w-full h-screen sm:h-[85vh] bg-blue-800">
            ...
            <div className="details-and-poster flex flex-col sm:flex-row justify-around items-center absolute z-10 top-0 w-full h-[100vh] pt-1 sm:h-[85vh] 2xl:pl-36 xl:pl-24 lg:pl-16">
