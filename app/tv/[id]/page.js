...
const IndividualTV = ({ params }) => {
  ...
  return (
    <>
          ...
          <>
            <section className="backdrop-poster relative w-full h-screen sm:h-[85vh] bg-blue-800">
              <Image
                ...
                priority
              />
              <div className="backdrop-cover absolute top-0 w-full h-screen sm:h-[85vh] opacity-50"></div>
              <div className="details-and-poster flex flex-col sm:flex-row justify-center items-center absolute z-10 top-0 w-full h-screen sm:h-[85vh] 2xl:pl-36 xl:pl-24 lg:pl-16">
                ...
                <div className="details flex flex-col flex-wrap justify-center sm:max-w-[65vmax] sm:pl-8 gap-4 p-3 sm:p-0 text-white">
                  <div className="header relative space-y-1">
                    ...
                    <div className="header-info flex items-center text-base font-normal opacity-90 text gap-[3vmin]">
                      <p>
                  ...
                  {IndividualTVData.overview ? (
                    ...
                    <p className="text-base leading-tight font-normal mt-2">
                      ...
                      Qui rem sed excepturi impedit id est natus laborum magni
                      distinctio! Ut delectus deleniti hic neque laboriosam
                      debitis dolorum porro enim in.
                    </p>
                  )}
                </div>
              </div>
              ...
              <div className="cast flex flex-col pl-0 sm:pl-14 py-4 w-full sm:max-w-[75%] gap-2">
                ...
                <div className="slider flex w-full bg-white px-4 pt-2 pb-4 gap-4 overflow-x-auto">
                  {tvCastAndCrew.length > 0 ? (
                    ...
                    <LoadingSkeleton
                      cards={
                        tvCastAndCrew.length < 5 ? tvCastAndCrew.length : 5
                      }
                      heigth={250}
                      width={180}
                    />
              ...
              <div className="status-sec flex flex-col min-w-[25%] pl-5 sm:pl-10 pt-2 sm:pt-16 gap-4">
                <div className="header text-xl font-semibold leading-none">
                  <h1 className="break-words">
                    ...
                    <br />
                    <span className="font-bold">{IndividualTVData.name}</span>
                  </h1>
                </div>
                ...
                <div className="budget leading-none">
                  ...
                  {IndividualTVData.budget > 0 ? (
                    <p>$ {IndividualTVData.budget}</p>
                  ) : (
                ...
                <div className="revenue leading-none">
                  ...
                  {IndividualTVData.revenue > 0 ? (
                    <p>$ {IndividualTVData.revenue}</p>
                  ) : (
                    <p className="opacity-80">NA</p>
                  )}
                </div>
      ...
      {(Object.keys(IndividualTVData).length > 0 && <Footer />)}
    </>
  );
};
